...
This document reflects the level of support offered by **rmw_embeddedrtps** on different platforms as per the following
definitions:
...
The CI is expected to be run at least within a week from the last relevant changes for the current release of **rmw_embeddedrtps**.
